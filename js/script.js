$(document).ready(function () {
    ...
    let m_pi = document.querySelector(".m_pi");
    ...
    let pop_pi = document.querySelector(".pop_pi");
    ...
    m_pi.addEventListener("mouseenter", function () {
        pop_pi.classList.add("show");
    })
    m_pi.addEventListener("mouseleave", function () {
        pop_pi.classList.remove("show");
    })
